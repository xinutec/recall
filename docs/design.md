...
4. **Recall** — full-text search, time/speaker filtering. (Summaries + Q&A were
   built and then cut on 2026-09-06; they remain a *later* ambition, not a feature.)
...
"later" ambition and that is where they now sit again — the archive is searchable,
not answerable. The `llm-host` process survives the cut because it holds the
weights for a *different* project (life's emotion suggestions); recall simply
